...
<template>
  <div class="flex flex-col justify-between w-max">
    <div class="bg-white flex justify-between gap-x-1 z-50 border-2 border-primary rounded-md p-2 shadow-lg
    hover:bg-secondary active:bg-tertiary focus:bg-secondary">  <!--FIXME:weird sizing-->
    ...
    <Transition>
      <div v-if="isMenuOpen" class="border border-t-0 border-primary rounded-b-md p-2 shadow-md relative z-10">
        <slot></slot>
      </div>
    </Transition>
  </div>
